# StreamLiveX – Codex çalışma notları
...
## Codex için başlangıç istemi

> Bu StreamLiveX IPTV projesini incele. Önce AGENTS.md ve README_DOCKER.md dosyalarını oku. İstenen değişikliği mevcut mimariyi, altı dil desteğini, profil bazlı tercihleri ve kategori konum hafızasını bozmadan uygula. İş bitince npm run build çalıştır ve sonucu bildir.
